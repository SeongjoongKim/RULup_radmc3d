...
plt.savefig('RULup_'+mole1+'-'+mole2+'_'+tname+'_'+b_maj+'_M1.pdf', bbox_inches='tight', pad_inches=0.1,dpi=100)
#plt.show()
plt.clf()
...
plt.savefig('RULup_'+mole1+'-'+mole2+'_'+tname+'_'+b_maj+'_M2.pdf', bbox_inches='tight', pad_inches=0.1,dpi=100)
#plt.show()
plt.clf()
