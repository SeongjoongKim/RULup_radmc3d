...
fnameread      = ['image_12CO_21.out','image_13CO_21.out','image_13CO_32.out','image_C18O_21.out','image_C18O_32.out','image_CN_32.out','image_cont220GHz.out','image_cont336GHz.out']
outfile=['RULup_12CO_2-1_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_13CO_2-1_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_13CO_3-2_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_C18O_2-1_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_C18O_3-2_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_CN_3-2_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_cont220GHz_'+test+'_bmaj'+str(outbmaj)+'.fits','RULup_cont336GHz_'+test+'_bmaj'+str(outbmaj)+'.fits']
...
for j in range(len(fnameread)):
    ...
    im_Jypbeam=im_Jypbeam*beam_solidangle/pixcel_solidangle
    im_Jypbeam[np.isnan(im_Jypbeam)] = 0.0
    # Make fits header ------------------------------------------------------------------
    # Set velocity axis
    nchans=nlam
    chanstep=0.06
