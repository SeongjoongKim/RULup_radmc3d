...
plt.plot(rad_mod, cont336_mod, 'k',linestyles='--')
plt.plot(rad_mod, cont220_mod, 'b',linestyles='--')
...
plt.plot(rad2_mod, C12O_mod, 'k',linestyles='--')
plt.plot(rad_obs, CN_obs, 'r',label='Obs CN 3-2')
plt.plot(rad_mod, CN_mod, 'r',linestyles='--')
plt.plot(rad_obs, C13O_21_obs, 'g',label='Obs 13CO 2-1')
plt.plot(rad_mod, C13O_21_mod, 'g',linestyles='--')
plt.plot(rad_obs, C13O_32_obs, 'm',label='Obs 13CO 3-2')
plt.plot(rad_mod, C13O_32_mod, 'm',linestyles='--')
plt.plot(rad_obs, C18O_21_obs, 'b',label='Obs C18O 2-1')
plt.plot(rad_mod, C18O_21_mod, 'b',linestyles='--')
plt.plot(rad_obs, C18O_32_obs, 'orange',label='Obs C18O 3-2')
plt.plot(rad_mod, C18O_32_mod, 'orange',linestyles='--')
plt.tick_params(which='both',length=6,width=1.5,direction='in')
plt.legend(prop={'size':12},loc=0)
plt.tight_layout()
